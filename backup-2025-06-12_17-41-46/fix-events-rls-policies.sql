...
-- 2. Allow authenticated users to view all their own events
...
-- 5. Allow admins to update any event (including coordinates)
...
-- 6. Allow users to delete their own events
...
-- 7. Allow admins to delete any event
