        ...
        <div className="bg-gray-800/50 backdrop-blur-sm border border-gray-700/50 rounded-xl p-8">
          ...
          {activeTab === 'cache' && (
            <div className="space-y-6">
              ...
              <div className="bg-blue-500/10 border border-blue-500/20 rounded-lg p-4 mb-6">
                <div className="flex items-start space-x-3">
                  <HardDrive className="h-5 w-5 text-blue-400 mt-0.5 flex-shrink-0" />
                  <div>
                    <h4 className="text-sm font-medium text-blue-400">Service Worker & Caching</h4>
                    <p className="text-sm text-blue-300 mt-1">
                      Manage application caches, service worker status, and performance optimization. 
                      Clear caches when needed and monitor storage usage.
                    </p>
                  </div>
                </div>
              </div>

              <ServiceWorkerManager showFullInterface={true} />
            </div>
          )}
