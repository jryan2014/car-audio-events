-- STEP 5: Create Test Data for Competition Scoring System (FINAL)
...
-- 2. Create a competition event for testing (with created_by field)
DO $$
BEGIN
    IF NOT EXISTS (
        ...
        INSERT INTO public.events (
            ...
            'active',
            true,
            '29b931f5-c02e-4562-b249-278f86663b62'::uuid  -- Your user ID as organizer
        );
    ELSE
