...
-- Insert additional essential pages if they don't exist
INSERT INTO cms_pages (
    ...
    (
        'Help Center', 
        'help', 
        '<h1>Help Center</h1><p>Find answers to frequently asked questions and get support.</p><h2>Getting Started</h2><p>New to our platform? Here''s how to get started...</p>', 
