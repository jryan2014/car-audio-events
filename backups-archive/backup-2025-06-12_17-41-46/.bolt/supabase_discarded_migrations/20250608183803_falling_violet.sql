/*
  # Fix event_registrations.event_id column type and RLS policies

  1. Changes
    - Convert event_id column from integer to UUID safely
...
DO $$
BEGIN
  -- List of tables to ensure RLS is enabled
  DECLARE tables text[] := ARRAY[
    'users', 'user_roles', 'role_permissions', 'user_sessions', 
