...
BEGIN
  -- Get user's membership type and admin status
  SELECT 
    COALESCE(up.membership_type, 'public'),
    COALESCE(up.is_admin, false)
  INTO v_membership_type, v_is_admin
  ...
  -- Check permission based on membership type and specific permission
  CASE p_permission
    WHEN 'create_event' THEN
      v_has_permission := v_membership_type IN ('pro_competitor', 'retailer', 'manufacturer', 'organization', 'admin');
    WHEN 'create_directory_listing' THEN
      v_has_permission := v_membership_type IN ('retailer', 'manufacturer', 'organization', 'admin');
    WHEN 'access_analytics' THEN
      v_has_permission := v_membership_type IN ('organization', 'admin');
    WHEN 'manage_users' THEN
      v_has_permission := v_membership_type = 'admin';
    WHEN 'post_advertisement' THEN
      v_has_permission := v_membership_type IN ('free', 'pro_competitor', 'retailer', 'manufacturer', 'organization', 'admin');
    ELSE
...
BEGIN
  -- Delete expired user sessions (older than 30 days)
...
CREATE OR REPLACE FUNCTION "public"."create_advertisement"("p_title" "text", "p_description" "text", "p_price" numeric, "p_category" "text", "p_location" "text", "p_contact_info" "text", "p_image_urls" "text"[], "p_user_id" "uuid") RETURNS "uuid"
    LANGUAGE "plpgsql" SECURITY DEFINER
    SET "search_path" TO 'public'
    AS $$
DECLARE
...
ALTER FUNCTION "public"."create_advertisement"("p_title" "text", "p_description" "text", "p_price" numeric, "p_category" "text", "p_location" "text", "p_contact_info" "text", "p_image_urls" "text"[], "p_user_id" "uuid") OWNER TO "postgres";


CREATE OR REPLACE FUNCTION "public"."create_backup_job"("p_backup_type" "text", "p_schedule" "text", "p_retention_days" integer DEFAULT 30) RETURNS "uuid"
    LANGUAGE "plpgsql" SECURITY DEFINER
    SET "search_path" TO 'public'
    AS $$
DECLARE
...
ALTER FUNCTION "public"."create_backup_job"("p_backup_type" "text", "p_schedule" "text", "p_retention_days" integer) OWNER TO "postgres";


CREATE OR REPLACE FUNCTION "public"."create_cms_page"("p_title" "text", "p_slug" "text", "p_content" "text", "p_meta_description" "text", "p_published" boolean, "p_author_id" "uuid") RETURNS "uuid"
    LANGUAGE "plpgsql" SECURITY DEFINER
    SET "search_path" TO 'public'
    AS $$
DECLARE
...
ALTER FUNCTION "public"."create_cms_page"("p_title" "text", "p_slug" "text", "p_content" "text", "p_meta_description" "text", "p_published" boolean, "p_author_id" "uuid") OWNER TO "postgres";


CREATE OR REPLACE FUNCTION "public"."create_cms_page"("p_title" "text", "p_slug" "text", "p_content" "text", "p_meta_description" "text", "p_status" "text", "p_author_id" "uuid") RETURNS "uuid"
    LANGUAGE "plpgsql" SECURITY DEFINER
    SET "search_path" TO 'public'
    AS $$
DECLARE
...
BEGIN
  INSERT INTO cms_pages (
    title, slug, content, meta_description, status, author_id
  ) VALUES (
    p_title, p_slug, p_content, p_meta_description, p_status, p_author_id
  )
  RETURNING id INTO page_id;
...
ALTER FUNCTION "public"."create_cms_page"("p_title" "text", "p_slug" "text", "p_content" "text", "p_meta_description" "text", "p_status" "text", "p_author_id" "uuid") OWNER TO "postgres";


CREATE OR REPLACE FUNCTION "public"."create_competition_result"("p_event_id" "uuid", "p_participant_id" "uuid", "p_category" "text", "p_score" numeric, "p_judge_id" "uuid", "p_notes" "text") RETURNS "uuid"
    LANGUAGE "plpgsql" SECURITY DEFINER
    SET "search_path" TO 'public'
    AS $$
DECLARE
...
ALTER FUNCTION "public"."create_competition_result"("p_event_id" "uuid", "p_participant_id" "uuid", "p_category" "text", "p_score" numeric, "p_judge_id" "uuid", "p_notes" "text") OWNER TO "postgres";


CREATE OR REPLACE FUNCTION "public"."create_directory_listing"("p_business_name" "text", "p_description" "text", "p_category" "text", "p_address" "text", "p_city" "text", "p_state" "text", "p_zip_code" "text", "p_phone" "text", "p_email" "text", "p_website" "text", "p_owner_id" "uuid") RETURNS "uuid"
    LANGUAGE "plpgsql" SECURITY DEFINER
    SET "search_path" TO 'public'
    AS $$
DECLARE
...
BEGIN
  INSERT INTO directory_listings (
    business_name, description, category, address, city, state, zip_code,
    phone, email, website, owner_id, status
  ) VALUES (
    p_business_name, p_description, p_category, p_address, p_city, p_state, p_zip_code,
    p_phone, p_email, p_website, p_owner_id, 'pending'
  )
...
ALTER FUNCTION "public"."create_directory_listing"("p_business_name" "text", "p_description" "text", "p_category" "text", "p_address" "text", "p_city" "text", "p_state" "text", "p_zip_code" "text", "p_phone" "text", "p_email" "text", "p_website" "text", "p_owner_id" "uuid") OWNER TO "postgres";


CREATE OR REPLACE FUNCTION "public"."create_email_template"("p_name" "text", "p_subject" "text", "p_body_html" "text", "p_body_text" "text", "p_template_type" "text") RETURNS "uuid"
    LANGUAGE "plpgsql" SECURITY DEFINER
    SET "search_path" TO 'public'
    AS $$
DECLARE
...
ALTER FUNCTION "public"."create_email_template"("p_name" "text", "p_subject" "text", "p_body_html" "text", "p_body_text" "text", "p_template_type" "text") OWNER TO "postgres";


CREATE OR REPLACE FUNCTION "public"."create_event"("p_title" "text", "p_description" "text", "p_event_date" timestamp with time zone, "p_location" "text", "p_address" "text", "p_city" "text", "p_state" "text", "p_zip_code" "text", "p_entry_fee" numeric, "p_max_participants" integer, "p_contact_info" "text", "p_organizer_id" "uuid") RETURNS "uuid"
    LANGUAGE "plpgsql" SECURITY DEFINER
    SET "search_path" TO 'public'
    AS $$
DECLARE
...
BEGIN
  INSERT INTO events (
    title, description, event_date, location, address, city, state, zip_code,
    entry_fee, max_participants, contact_info, organizer_id, status
  ) VALUES (
    p_title, p_description, p_event_date, p_location, p_address, p_city, p_state, p_zip_code,
    p_entry_fee, p_max_participants, p_contact_info, p_organizer_id, 'draft'
  )
...
ALTER FUNCTION "public"."create_event"("p_title" "text", "p_description" "text", "p_event_date" timestamp with time zone, "p_location" "text", "p_address" "text", "p_city" "text", "p_state" "text", "p_zip_code" "text", "p_entry_fee" numeric, "p_max_participants" integer, "p_contact_info" "text", "p_organizer_id" "uuid") OWNER TO "postgres";


CREATE OR REPLACE FUNCTION "public"."create_organization"("p_name" "text", "p_description" "text", "p_type" "text", "p_website" "text", "p_contact_email" "text", "p_contact_phone" "text", "p_address" "text", "p_city" "text", "p_state" "text", "p_zip_code" "text", "p_owner_id" "uuid") RETURNS "uuid"
    LANGUAGE "plpgsql" SECURITY DEFINER
    SET "search_path" TO 'public'
    AS $$
DECLARE
...
BEGIN
  INSERT INTO organizations (
    name, description, type, website, contact_email, contact_phone,
    address, city, state, zip_code, owner_id, status
  ) VALUES (
    p_name, p_description, p_type, p_website, p_contact_email, p_contact_phone,
    p_address, p_city, p_state, p_zip_code, p_owner_id, 'pending'
  )
...
ALTER FUNCTION "public"."create_organization"("p_name" "text", "p_description" "text", "p_type" "text", "p_website" "text", "p_contact_email" "text", "p_contact_phone" "text", "p_address" "text", "p_city" "text", "p_state" "text", "p_zip_code" "text", "p_owner_id" "uuid") OWNER TO "postgres";


CREATE OR REPLACE FUNCTION "public"."create_scraping_job"("p_url" "text", "p_selector" "text", "p_description" "text", "p_schedule" "text" DEFAULT 'manual'::"text") RETURNS "uuid"
    LANGUAGE "plpgsql" SECURITY DEFINER
    SET "search_path" TO 'public'
    AS $$
DECLARE
...
BEGIN
  ...
  IF NOT EXISTS (
    SELECT 1 FROM user_profiles 
    WHERE user_id = auth.uid() 
    AND membership_tier IN ('Pro Competitor', 'Retailer', 'Manufacturer', 'Organization', 'Admin')
  ) THEN
    RAISE EXCEPTION 'Access denied. Pro membership or higher required.';
  END IF;
...
ALTER FUNCTION "public"."create_scraping_job"("p_url" "text", "p_selector" "text", "p_description" "text", "p_schedule" "text") OWNER TO "postgres";
...
CREATE OR REPLACE FUNCTION "public"."get_user_analytics"() RETURNS TABLE("total_users" bigint, "active_users" bigint, "new_users_this_month" bigint)
    LANGUAGE "plpgsql" SECURITY DEFINER
    SET "search_path" TO 'public'
    AS $$
BEGIN
...
CREATE OR REPLACE FUNCTION "public"."log_system_event"("p_event_type" "text", "p_description" "text", "p_user_id" "uuid" DEFAULT NULL::"uuid", "p_metadata" "jsonb" DEFAULT NULL::"jsonb") RETURNS "uuid"
    LANGUAGE "plpgsql" SECURITY DEFINER
    SET "search_path" TO 'public'
    AS $$
DECLARE
...
ALTER FUNCTION "public"."log_system_event"("p_event_type" "text", "p_description" "text", "p_user_id" "uuid", "p_metadata" "jsonb") OWNER TO "postgres";
...
CREATE OR REPLACE FUNCTION "public"."manage_user_session"("p_action" "text", "p_session_data" "jsonb" DEFAULT NULL::"jsonb") RETURNS "void"
    LANGUAGE "plpgsql" SECURITY DEFINER
    SET "search_path" TO 'public'
    AS $$
BEGIN
  -- Validate action parameter
  IF p_action NOT IN ('login', 'logout', 'refresh', 'cleanup') THEN
    RAISE EXCEPTION 'Invalid action. Must be login, logout, refresh, or cleanup.';
  END IF;
  ...
  CASE p_action
    WHEN 'login' THEN
      ...
      INSERT INTO user_sessions (
        ...
        auth.uid(),
        COALESCE(p_session_data->>'session_id', gen_random_uuid()::text),
        inet_client_addr(),
    ...
    WHEN 'logout' THEN
      ...
      WHERE user_id = auth.uid() 
      AND session_id = p_session_data->>'session_id';
...
ALTER FUNCTION "public"."manage_user_session"("p_action" "text", "p_session_data" "jsonb") OWNER TO "postgres";
...
CREATE OR REPLACE FUNCTION "public"."perform_global_search"("p_query" "text", "p_search_type" "text" DEFAULT 'all'::"text", "p_limit" integer DEFAULT 50) RETURNS TABLE("result_type" "text", "result_id" "uuid", "title" "text", "description" "text", "url" "text", "relevance_score" numeric)
    LANGUAGE "plpgsql" SECURITY DEFINER
    SET "search_path" TO 'public'
    AS $$
BEGIN
  ...
  IF p_search_type NOT IN ('all', 'events', 'organizations', 'users') THEN
    RAISE EXCEPTION 'Invalid search type. Must be all, events, organizations, or users.';
  END IF;

  -- Return search results based on type
  RETURN QUERY
  SELECT * FROM (
    -- Search events
    SELECT 
    ...
    FROM events e
    WHERE (p_search_type = 'all' OR p_search_type = 'events')
    ...
    SELECT 
      ...
      o.name as title,
      o.description,
      '/directory/' || o.id as url,
      ts_rank(to_tsvector('english', o.name || ' ' || COALESCE(o.description, '')), 
              plainto_tsquery('english', p_query)) as relevance_score
    FROM organizations o
    WHERE (p_search_type = 'all' OR p_search_type = 'organizations')
    AND (o.name ILIKE '%' || p_query || '%' OR o.description ILIKE '%' || p_query || '%')
    AND o.status = 'active'
    
    UNION ALL
    
    -- Search users (limited to public profiles only)
    SELECT 
      'user'::text as result_type,
      up.user_id as result_id,
      up.display_name as title,
      up.bio as description,
      '/users/' || up.user_id as url,
      ts_rank(to_tsvector('english', up.display_name || ' ' || COALESCE(up.bio, '')), 
              plainto_tsquery('english', p_query)) as relevance_score
    FROM user_profiles up
    WHERE (p_search_type = 'all' OR p_search_type = 'users')
    AND up.display_name ILIKE '%' || p_query || '%'
...
ALTER FUNCTION "public"."perform_global_search"("p_query" "text", "p_search_type" "text", "p_limit" integer) OWNER TO "postgres";


CREATE OR REPLACE FUNCTION "public"."process_event_payment"("p_registration_id" "uuid", "p_payment_amount" numeric, "p_payment_method" "text", "p_stripe_payment_intent_id" "text") RETURNS boolean
    LANGUAGE "plpgsql" SECURITY DEFINER
    SET "search_path" TO 'public'
    AS $$
BEGIN
...
ALTER FUNCTION "public"."process_event_payment"("p_registration_id" "uuid", "p_payment_amount" numeric, "p_payment_method" "text", "p_stripe_payment_intent_id" "text") OWNER TO "postgres";
...
CREATE OR REPLACE FUNCTION "public"."register_for_event"("p_event_id" "uuid", "p_user_id" "uuid", "p_vehicle_info" "jsonb", "p_category" "text") RETURNS "uuid"
    LANGUAGE "plpgsql" SECURITY DEFINER
    SET "search_path" TO 'public'
    AS $$
DECLARE
...
BEGIN
  ...
  IF current_registrations >= max_participants THEN
    RAISE EXCEPTION 'Event is full';
  END IF;
  
  -- Create registration
  INSERT INTO event_registrations (
    event_id, user_id, vehicle_info, category, status
  ) VALUES (
    p_event_id, p_user_id, p_vehicle_info, p_category, 'pending'
  )
...
ALTER FUNCTION "public"."register_for_event"("p_event_id" "uuid", "p_user_id" "uuid", "p_vehicle_info" "jsonb", "p_category" "text") OWNER TO "postgres";


CREATE OR REPLACE FUNCTION "public"."send_notification"("p_user_id" "uuid", "p_type" "text", "p_title" "text", "p_message" "text", "p_data" "jsonb" DEFAULT '{}'::"jsonb") RETURNS "uuid"
    LANGUAGE "plpgsql" SECURITY DEFINER
    SET "search_path" TO 'public'
    AS $$
DECLARE
...
ALTER FUNCTION "public"."send_notification"("p_user_id" "uuid", "p_type" "text", "p_title" "text", "p_message" "text", "p_data" "jsonb") OWNER TO "postgres";
...
CREATE OR REPLACE FUNCTION "public"."track_page_view"("p_page_path" "text", "p_user_agent" "text" DEFAULT NULL::"text", "p_referrer" "text" DEFAULT NULL::"text") RETURNS "void"
    LANGUAGE "plpgsql" SECURITY DEFINER
    SET "search_path" TO 'public'
    AS $$
BEGIN
  ...
  DO UPDATE SET
    view_count = daily_analytics.view_count + 1,
    unique_visitors = daily_analytics.unique_visitors + 
      CASE WHEN auth.uid() IS NOT NULL AND NOT EXISTS (
...
ALTER FUNCTION "public"."track_page_view"("p_page_path" "text", "p_user_agent" "text", "p_referrer" "text") OWNER TO "postgres";
...
CREATE OR REPLACE FUNCTION "public"."update_advertisement"("p_ad_id" "uuid", "p_title" "text", "p_description" "text", "p_price" numeric, "p_category" "text", "p_location" "text", "p_contact_info" "text", "p_image_urls" "text"[]) RETURNS boolean
    LANGUAGE "plpgsql" SECURITY DEFINER
    SET "search_path" TO 'public'
    AS $$
BEGIN
...
ALTER FUNCTION "public"."update_advertisement"("p_ad_id" "uuid", "p_title" "text", "p_description" "text", "p_price" numeric, "p_category" "text", "p_location" "text", "p_contact_info" "text", "p_image_urls" "text"[]) OWNER TO "postgres";
...
CREATE OR REPLACE FUNCTION "public"."update_ai_config"("p_config_key" "text", "p_config_value" "text", "p_description" "text" DEFAULT NULL::"text") RETURNS "void"
    LANGUAGE "plpgsql" SECURITY DEFINER
    SET "search_path" TO 'public'
    AS $$
BEGIN
  ...
  -- Update or insert AI configuration
  INSERT INTO ai_configurations (config_key, config_value, description, updated_at)
  VALUES (p_config_key, p_config_value, p_description, NOW())
  ON CONFLICT (config_key) 
  DO UPDATE SET 
    config_value = EXCLUDED.config_value,
    description = COALESCE(EXCLUDED.description, ai_configurations.description),
    updated_at = NOW();
END;
$$;


ALTER FUNCTION "public"."update_ai_config"("p_config_key" "text", "p_config_value" "text", "p_description" "text") OWNER TO "postgres";


CREATE OR REPLACE FUNCTION "public"."update_ai_usage_analytics"() RETURNS "trigger"
    LANGUAGE "plpgsql"
    AS $$
BEGIN
...
ALTER FUNCTION "public"."update_ai_usage_analytics"() OWNER TO "postgres";


CREATE OR REPLACE FUNCTION "public"."update_cms_page"("p_page_id" "uuid", "p_title" "text", "p_slug" "text", "p_content" "text", "p_meta_description" "text", "p_published" boolean) RETURNS boolean
    LANGUAGE "plpgsql" SECURITY DEFINER
    SET "search_path" TO 'public'
    AS $$
BEGIN
...
ALTER FUNCTION "public"."update_cms_page"("p_page_id" "uuid", "p_title" "text", "p_slug" "text", "p_content" "text", "p_meta_description" "text", "p_published" boolean) OWNER TO "postgres";


CREATE OR REPLACE FUNCTION "public"."update_competition_result"("p_result_id" "uuid", "p_score" numeric, "p_notes" "text", "p_judge_id" "uuid") RETURNS boolean
    LANGUAGE "plpgsql" SECURITY DEFINER
    SET "search_path" TO 'public'
    AS $$
BEGIN
...
ALTER FUNCTION "public"."update_competition_result"("p_result_id" "uuid", "p_score" numeric, "p_notes" "text", "p_judge_id" "uuid") OWNER TO "postgres";


CREATE OR REPLACE FUNCTION "public"."update_directory_listing"("p_listing_id" "uuid", "p_business_name" "text", "p_description" "text", "p_category" "text", "p_address" "text", "p_city" "text", "p_state" "text", "p_zip_code" "text", "p_phone" "text", "p_email" "text", "p_website" "text") RETURNS "void"
    LANGUAGE "plpgsql" SECURITY DEFINER
    SET "search_path" TO 'public'
    AS $$
BEGIN
...
ALTER FUNCTION "public"."update_directory_listing"("p_listing_id" "uuid", "p_business_name" "text", "p_description" "text", "p_category" "text", "p_address" "text", "p_city" "text", "p_state" "text", "p_zip_code" "text", "p_phone" "text", "p_email" "text", "p_website" "text") OWNER TO "postgres";


CREATE OR REPLACE FUNCTION "public"."update_event"("p_event_id" "uuid", "p_title" "text", "p_description" "text", "p_event_date" timestamp with time zone, "p_location" "text", "p_address" "text", "p_city" "text", "p_state" "text", "p_zip_code" "text", "p_entry_fee" numeric, "p_max_participants" integer, "p_contact_info" "text") RETURNS "void"
    LANGUAGE "plpgsql" SECURITY DEFINER
    SET "search_path" TO 'public'
    AS $$
BEGIN
...
ALTER FUNCTION "public"."update_event"("p_event_id" "uuid", "p_title" "text", "p_description" "text", "p_event_date" timestamp with time zone, "p_location" "text", "p_address" "text", "p_city" "text", "p_state" "text", "p_zip_code" "text", "p_entry_fee" numeric, "p_max_participants" integer, "p_contact_info" "text") OWNER TO "postgres";
...
CREATE OR REPLACE FUNCTION "public"."update_organization"("p_org_id" "uuid", "p_name" "text", "p_description" "text", "p_type" "text", "p_website" "text", "p_contact_email" "text", "p_contact_phone" "text", "p_address" "text", "p_city" "text", "p_state" "text", "p_zip_code" "text") RETURNS "void"
    LANGUAGE "plpgsql" SECURITY DEFINER
    SET "search_path" TO 'public'
    AS $$
BEGIN
...
ALTER FUNCTION "public"."update_organization"("p_org_id" "uuid", "p_name" "text", "p_description" "text", "p_type" "text", "p_website" "text", "p_contact_email" "text", "p_contact_phone" "text", "p_address" "text", "p_city" "text", "p_state" "text", "p_zip_code" "text") OWNER TO "postgres";


CREATE OR REPLACE FUNCTION "public"."update_subscription"("p_user_id" "uuid", "p_membership_tier" "text", "p_subscription_status" "text", "p_subscription_end_date" timestamp with time zone DEFAULT NULL::timestamp with time zone) RETURNS "void"
    LANGUAGE "plpgsql" SECURITY DEFINER
    SET "search_path" TO 'public'
    AS $$
BEGIN
  ...
  IF NOT (
    ...
    RAISE EXCEPTION 'Access denied. Can only update own subscription or must be admin.';
  END IF;

  -- Update user profile with new subscription details
  UPDATE user_profiles 
  SET 
    membership_tier = p_membership_tier,
...
ALTER FUNCTION "public"."update_subscription"("p_user_id" "uuid", "p_membership_tier" "text", "p_subscription_status" "text", "p_subscription_end_date" timestamp with time zone) OWNER TO "postgres";


CREATE OR REPLACE FUNCTION "public"."update_system_config"("p_config_key" "text", "p_config_value" "text", "p_description" "text" DEFAULT NULL::"text") RETURNS "void"
    LANGUAGE "plpgsql" SECURITY DEFINER
    SET "search_path" TO 'public'
    AS $$
BEGIN
  ...
  INSERT INTO system_configurations (config_key, config_value, description, updated_at, updated_by)
  VALUES (p_config_key, p_config_value, p_description, NOW(), auth.uid())
  ON CONFLICT (config_key) 
  DO UPDATE SET 
    config_value = EXCLUDED.config_value,
  ...
  INSERT INTO configuration_history (
    ...
    p_config_key,
    (SELECT config_value FROM system_configurations WHERE config_key = p_config_key),
    p_config_value,
    auth.uid(),
    NOW()
  );
...
ALTER FUNCTION "public"."update_system_config"("p_config_key" "text", "p_config_value" "text", "p_description" "text") OWNER TO "postgres";
...
CREATE OR REPLACE FUNCTION "public"."update_user_last_login"("user_id" "uuid") RETURNS "void"
    LANGUAGE "plpgsql" SECURITY DEFINER
    SET "search_path" TO 'public'
    AS $$
BEGIN
...
ALTER FUNCTION "public"."update_user_last_login"("user_id" "uuid") OWNER TO "postgres";


CREATE OR REPLACE FUNCTION "public"."update_user_profile"("user_id_param" "uuid", "first_name_param" "text", "last_name_param" "text", "phone_param" "text", "city_param" "text", "state_param" "text", "membership_level_param" "text") RETURNS "void"
    LANGUAGE "plpgsql" SECURITY DEFINER
    SET "search_path" TO 'public'
    AS $$
BEGIN
  ...
  SET 
    ...
    city = city_param,
    state = state_param,
    membership_level = membership_level_param,
    updated_at = NOW()
...
ALTER FUNCTION "public"."update_user_profile"("user_id_param" "uuid", "first_name_param" "text", "last_name_param" "text", "phone_param" "text", "city_param" "text", "state_param" "text", "membership_level_param" "text") OWNER TO "postgres";
...
CREATE OR REPLACE FUNCTION "public"."validate_email_format"("p_email" "text") RETURNS boolean
    LANGUAGE "plpgsql" SECURITY DEFINER
    SET "search_path" TO 'public'
    AS $_$
BEGIN
...
ALTER FUNCTION "public"."validate_email_format"("p_email" "text") OWNER TO "postgres";
...
CREATE TABLE IF NOT EXISTS "public"."ai_content_directions" (
    "id" "uuid" DEFAULT "extensions"."uuid_generate_v4"() NOT NULL,
    "user_id" "uuid",
    "organization_id" integer,
    "brand_voice" character varying(50) DEFAULT 'professional'::character varying NOT NULL,
    "writing_style" character varying(50) DEFAULT 'informative'::character varying NOT NULL,
    "target_audience" "text" DEFAULT 'car audio enthusiasts'::"text" NOT NULL,
    "key_messages" "jsonb" DEFAULT '[]'::"jsonb" NOT NULL,
    "tone_guidelines" "text",
    "format_preferences" "jsonb" DEFAULT '{"useQuotes": false, "useHeadings": true, "useSubheadings": false, "preferredLength": "medium", "useBulletPoints": true, "useNumberedLists": false, "includeConclusion": true, "includeStatistics": false, "addSourceReferences": false, "includeCallToAction": true, "includeIntroduction": true, "includeTechnicalSpecs": true, "useEmphasisFormatting": true}'::"jsonb" NOT NULL,
    "content_types" "jsonb" DEFAULT '{"blogPosts": true, "emailCampaigns": true, "socialMediaPosts": true, "eventAnnouncements": true, "productDescriptions": true}'::"jsonb" NOT NULL,
    "restrictions" "jsonb" DEFAULT '{"maxWordCount": 500, "minWordCount": 50, "avoidSuperlatives": false, "includeDisclaimer": false, "requireFactChecking": true}'::"jsonb" NOT NULL,
    "created_at" timestamp with time zone DEFAULT "now"(),
    "updated_at" timestamp with time zone DEFAULT "now"(),
    CONSTRAINT "ai_content_directions_check" CHECK (((("user_id" IS NOT NULL) AND ("organization_id" IS NULL)) OR (("user_id" IS NULL) AND ("organization_id" IS NOT NULL))))
);


ALTER TABLE "public"."ai_content_directions" OWNER TO "postgres";
...
CREATE TABLE IF NOT EXISTS "public"."ai_generated_images" (
    ...
    "usage_log_id" "uuid",
    "image_url" "text" NOT NULL,
    "image_size_name" character varying(50) NOT NULL,
...
CREATE TABLE IF NOT EXISTS "public"."ai_generated_text" (
    "id" "uuid" DEFAULT "extensions"."uuid_generate_v4"() NOT NULL,
    "usage_log_id" "uuid",
...
ALTER TABLE "public"."ai_generated_text" OWNER TO "postgres";


CREATE TABLE IF NOT EXISTS "public"."ai_image_guidelines" (
    "id" "uuid" DEFAULT "extensions"."uuid_generate_v4"() NOT NULL,
    "user_id" "uuid",
    "organization_id" integer,
    "visual_style" character varying(50) DEFAULT 'modern'::character varying NOT NULL,
    "color_scheme" "jsonb" DEFAULT '{"text": "#1e293b", "accent": "#f59e0b", "primary": "#0ea5e9", "secondary": "#64748b", "background": "#ffffff"}'::"jsonb" NOT NULL,
    "composition_style" character varying(50) DEFAULT 'balanced'::character varying NOT NULL,
    "preferred_layouts" "jsonb" DEFAULT '["centered", "rule-of-thirds", "asymmetrical"]'::"jsonb" NOT NULL,
    "text_overlay_zones" "jsonb" DEFAULT '{"cta": {"width": "30%", "height": "20%", "position": "bottom-right"}, "offer": {"width": "25%", "height": "25%", "position": "top-right"}, "header": {"height": "25%", "position": "top", "alignment": "center"}, "contact": {"height": "15%", "position": "bottom", "alignment": "center"}, "product": {"width": "60%", "height": "40%", "position": "center"}}'::"jsonb" NOT NULL,
    "logo_placement" character varying(50) DEFAULT 'bottom-right'::character varying NOT NULL,
    "brand_colors_required" boolean DEFAULT true,
    "watermark_required" boolean DEFAULT false,
    "preferred_dimensions" "jsonb" DEFAULT '{"story": {"width": 1080, "height": 1920}, "banner": {"width": 1200, "height": 400}, "square": {"width": 800, "height": 800}, "portrait": {"width": 600, "height": 900}}'::"jsonb" NOT NULL,
    "avoid_elements" "jsonb" DEFAULT '["cluttered_backgrounds", "small_text", "too_many_colors"]'::"jsonb" NOT NULL,
    "required_elements" "jsonb" DEFAULT '["clear_focal_point", "readable_text", "brand_consistency"]'::"jsonb" NOT NULL,
    "created_at" timestamp with time zone DEFAULT "now"(),
    "updated_at" timestamp with time zone DEFAULT "now"(),
    CONSTRAINT "ai_image_guidelines_check" CHECK (((("user_id" IS NOT NULL) AND ("organization_id" IS NULL)) OR (("user_id" IS NULL) AND ("organization_id" IS NOT NULL))))
);


ALTER TABLE "public"."ai_image_guidelines" OWNER TO "postgres";
...
CREATE TABLE IF NOT EXISTS "public"."ai_provider_configs" (
    ...
    "cost_per_request" numeric(10,4) DEFAULT 0.0000 NOT NULL,
    "daily_request_limit" integer DEFAULT 100 NOT NULL,
    "monthly_cost_limit" numeric(10,2) DEFAULT 100.00 NOT NULL,
    "created_at" timestamp with time zone DEFAULT "now"(),
    "updated_at" timestamp with time zone DEFAULT "now"(),
    CONSTRAINT "ai_provider_configs_check" CHECK (((("user_id" IS NOT NULL) AND ("organization_id" IS NULL)) OR (("user_id" IS NULL) AND ("organization_id" IS NOT NULL)))),
    CONSTRAINT "ai_provider_configs_max_tokens_check" CHECK ((("max_tokens" > 0) OR ("max_tokens" IS NULL))),
    CONSTRAINT "ai_provider_configs_quality_check" CHECK (((("quality")::"text" = ANY ((ARRAY['standard'::character varying, 'hd'::character varying])::"text"[])) OR ("quality" IS NULL))),
    CONSTRAINT "ai_provider_configs_style_check" CHECK (((("style")::"text" = ANY ((ARRAY['vivid'::character varying, 'natural'::character varying])::"text"[])) OR ("style" IS NULL))),
    CONSTRAINT "ai_provider_configs_temperature_check" CHECK (((("temperature" >= (0)::numeric) AND ("temperature" <= (2)::numeric)) OR ("temperature" IS NULL)))
);
...
CREATE TABLE IF NOT EXISTS "public"."ai_service_providers" (
    ...
    "created_at" timestamp with time zone DEFAULT "now"(),
    "updated_at" timestamp with time zone DEFAULT "now"(),
    CONSTRAINT "ai_service_providers_service_type_check" CHECK ((("service_type")::"text" = ANY ((ARRAY['image'::character varying, 'text'::character varying])::"text"[])))
);


ALTER TABLE "public"."ai_service_providers" OWNER TO "postgres";
...
CREATE TABLE IF NOT EXISTS "public"."ai_usage_analytics" (
    ...
    "text_pieces_generated" integer DEFAULT 0 NOT NULL,
    "created_at" timestamp with time zone DEFAULT "now"(),
    "updated_at" timestamp with time zone DEFAULT "now"(),
    CONSTRAINT "ai_usage_analytics_period_type_check" CHECK ((("period_type")::"text" = ANY ((ARRAY['daily'::character varying, 'weekly'::character varying, 'monthly'::character varying])::"text"[])))
);


ALTER TABLE "public"."ai_usage_analytics" OWNER TO "postgres";


CREATE OR REPLACE VIEW "public"."ai_provider_usage_summary" AS
 SELECT "asp"."provider_name",
    "asp"."display_name",
    "asp"."service_type",
    "count"("apc"."id") AS "total_configurations",
    "count"(
        CASE
            WHEN "apc"."enabled" THEN 1
            ELSE NULL::integer
        END) AS "active_configurations",
    COALESCE("sum"("aua"."total_requests"), (0)::bigint) AS "total_requests_today",
    COALESCE("sum"("aua"."successful_requests"), (0)::bigint) AS "successful_requests_today",
    COALESCE("sum"("aua"."total_cost"), (0)::numeric) AS "total_cost_today",
    COALESCE("sum"("aua"."images_generated"), (0)::bigint) AS "images_generated_today",
    COALESCE("sum"("aua"."text_pieces_generated"), (0)::bigint) AS "text_pieces_generated_today"
   FROM (("public"."ai_service_providers" "asp"
     LEFT JOIN "public"."ai_provider_configs" "apc" ON (("asp"."id" = "apc"."provider_id")))
     LEFT JOIN "public"."ai_usage_analytics" "aua" ON ((("apc"."id" = "aua"."config_id") AND (("aua"."period_type")::"text" = 'daily'::"text") AND ("aua"."date_period" = CURRENT_DATE))))
...
ALTER TABLE "public"."ai_provider_usage_summary" OWNER TO "postgres";
...
CREATE TABLE IF NOT EXISTS "public"."ai_usage_logs" (
    ...
    "error_message" "text",
    "tokens_used" integer,
    "cost_incurred" numeric(10,4) DEFAULT 0.0000 NOT NULL,
    "processing_time_ms" integer,
    "source_feature" character varying(50),
    "source_id" "uuid",
    "created_at" timestamp with time zone DEFAULT "now"(),
    CONSTRAINT "ai_usage_logs_request_type_check" CHECK ((("request_type")::"text" = ANY ((ARRAY['image'::character varying, 'text'::character varying])::"text"[])))
);
...
CREATE OR REPLACE VIEW "public"."ai_user_usage_summary" AS
 SELECT COALESCE(("apc"."user_id")::"text", ("apc"."organization_id")::"text") AS "entity_id",
        CASE
            WHEN ("apc"."user_id" IS NOT NULL) THEN 'user'::"text"
   ...
   FROM ("public"."ai_provider_configs" "apc"
     LEFT JOIN "public"."ai_usage_analytics" "aua" ON ((("apc"."id" = "aua"."config_id") AND (("aua"."period_type")::"text" = 'daily'::"text") AND ("aua"."date_period" = CURRENT_DATE))))
  GROUP BY COALESCE(("apc"."user_id")::"text", ("apc"."organization_id")::"text"),
        CASE
            WHEN ("apc"."user_id" IS NOT NULL) THEN 'user'::"text"
            ELSE 'organization'::"text"
        END
  ORDER BY COALESCE("sum"("aua"."total_cost"), (0)::numeric) DESC;


ALTER TABLE "public"."ai_user_usage_summary" OWNER TO "postgres";
...
CREATE TABLE IF NOT EXISTS "public"."users" (
    ...
    "subscription_plan" character varying(50) DEFAULT 'monthly'::character varying,
    ...
    "admin_discount_percentage" numeric(5,2),
    "admin_discount_amount" numeric(10,2),
    "admin_discount_reason" "text",
    "admin_discount_applied_by" "uuid",
    "admin_discount_applied_at" timestamp with time zone,
    ...
    CONSTRAINT "users_membership_type_check" CHECK ((("membership_type")::"text" = ANY ((ARRAY['competitor'::character varying, 'pro_competitor'::character varying, 'retailer'::character varying, 'manufacturer'::character varying, 'organization'::character varying, 'support_member'::character varying, 'admin'::character varying])::"text"[]))),
    CONSTRAINT "users_payment_method_check" CHECK (((("payment_method")::"text" = ANY ((ARRAY['credit_card'::character varying, 'paypal'::character varying, 'bank_transfer'::character varying, 'cashiers_check'::character varying])::"text"[])) OR ("payment_method" IS NULL))),
...
COMMENT ON COLUMN "public"."users"."membership_type" IS 'User role: competitor (free), pro_competitor (paid), retailer, manufacturer, organization, support_member (event staff), admin';



COMMENT ON COLUMN "public"."users"."subscription_plan" IS 'Billing frequency: monthly, yearly (NO lifetime option)';



COMMENT ON COLUMN "public"."users"."admin_discount_percentage" IS 'Admin-applied discount percentage (0-100)';



COMMENT ON COLUMN "public"."users"."admin_discount_amount" IS 'Admin-applied discount dollar amount (USD)';



COMMENT ON COLUMN "public"."users"."terms_accepted" IS 'User accepted Terms of Service';



COMMENT ON COLUMN "public"."users"."privacy_accepted" IS 'User accepted Privacy Policy';



COMMENT ON COLUMN "public"."users"."newsletter_subscribed" IS 'User opted into newsletters';



COMMENT ON COLUMN "public"."users"."payment_method" IS 'Payment method: credit_card, paypal, bank_transfer (mfg/org only), cashiers_check (mfg/org only)';
...
ALTER TABLE "public"."team_images" OWNER TO "postgres";
...
CREATE TABLE IF NOT EXISTS "public"."user_settings" (
    ...
    "show_audio_systems" boolean DEFAULT true,
    "show_competition_results" boolean DEFAULT true,
    "show_team_memberships" boolean DEFAULT true,
    "show_achievements" boolean DEFAULT true,
    "created_at" timestamp with time zone DEFAULT "now"(),
    "updated_at" timestamp with time zone DEFAULT "now"(),
    CONSTRAINT "user_settings_profile_visibility_check" CHECK (("profile_visibility" = ANY (ARRAY['public'::"text", 'private'::"text", 'members_only'::"text"])))
);
...
CREATE TABLE IF NOT EXISTS "public"."verification_documents" (
    ...
    "reviewed_at" timestamp with time zone,
    "reviewed_by" "uuid",
    CONSTRAINT "verification_documents_document_type_check" CHECK (("document_type" = ANY (ARRAY['id'::"text", 'ein'::"text", 'business_license'::"text", 'credit_card'::"text", 'bank_statement'::"text", 'other'::"text"]))),
...
ALTER TABLE ONLY "public"."ai_content_directions"
    ADD CONSTRAINT "ai_content_directions_pkey" PRIMARY KEY ("id");
...
ALTER TABLE ONLY "public"."ai_generated_text"
    ADD CONSTRAINT "ai_generated_text_pkey" PRIMARY KEY ("id");



ALTER TABLE ONLY "public"."ai_image_guidelines"
    ADD CONSTRAINT "ai_image_guidelines_pkey" PRIMARY KEY ("id");



ALTER TABLE ONLY "public"."ai_provider_configs"
    ADD CONSTRAINT "ai_provider_configs_organization_id_provider_id_key" UNIQUE ("organization_id", "provider_id");
...
ALTER TABLE ONLY "public"."ai_provider_configs"
    ADD CONSTRAINT "ai_provider_configs_user_id_provider_id_key" UNIQUE ("user_id", "provider_id");



ALTER TABLE ONLY "public"."ai_service_providers"
    ADD CONSTRAINT "ai_service_providers_pkey" PRIMARY KEY ("id");



ALTER TABLE ONLY "public"."ai_service_providers"
    ADD CONSTRAINT "ai_service_providers_provider_name_key" UNIQUE ("provider_name");



ALTER TABLE ONLY "public"."ai_usage_analytics"
    ADD CONSTRAINT "ai_usage_analytics_config_id_period_type_date_period_key" UNIQUE ("config_id", "period_type", "date_period");
...
CREATE INDEX "idx_ai_generated_images_active" ON "public"."ai_generated_images" USING "btree" ("is_active", "is_archived");



CREATE INDEX "idx_ai_generated_images_advertiser" ON "public"."ai_generated_images" USING "btree" ("advertiser_id");



CREATE INDEX "idx_ai_generated_images_usage_log" ON "public"."ai_generated_images" USING "btree" ("usage_log_id");



CREATE INDEX "idx_ai_generated_text_active" ON "public"."ai_generated_text" USING "btree" ("is_active", "is_archived");



CREATE INDEX "idx_ai_generated_text_advertiser" ON "public"."ai_generated_text" USING "btree" ("advertiser_id");



CREATE INDEX "idx_ai_generated_text_usage_log" ON "public"."ai_generated_text" USING "btree" ("usage_log_id");



CREATE INDEX "idx_ai_usage_analytics_config_period" ON "public"."ai_usage_analytics" USING "btree" ("config_id", "date_period");



CREATE INDEX "idx_ai_usage_analytics_period_type" ON "public"."ai_usage_analytics" USING "btree" ("period_type", "date_period");



CREATE INDEX "idx_ai_usage_logs_config_id" ON "public"."ai_usage_logs" USING "btree" ("config_id");
...
CREATE INDEX "idx_ai_usage_logs_source" ON "public"."ai_usage_logs" USING "btree" ("source_feature", "source_id");
...
CREATE INDEX "idx_team_images_team_id" ON "public"."team_images" USING "btree" ("team_id");
...
CREATE INDEX "idx_users_newsletter_subscribed" ON "public"."users" USING "btree" ("newsletter_subscribed");



CREATE INDEX "idx_users_payment_method" ON "public"."users" USING "btree" ("payment_method");
...
CREATE OR REPLACE TRIGGER "trigger_update_ai_usage_analytics" AFTER INSERT ON "public"."ai_usage_logs" FOR EACH ROW EXECUTE FUNCTION "public"."update_ai_usage_analytics"();
...
ALTER TABLE ONLY "public"."ai_content_directions"
    ADD CONSTRAINT "ai_content_directions_organization_id_fkey" FOREIGN KEY ("organization_id") REFERENCES "public"."organizations"("id") ON DELETE CASCADE;



ALTER TABLE ONLY "public"."ai_content_directions"
    ADD CONSTRAINT "ai_content_directions_user_id_fkey" FOREIGN KEY ("user_id") REFERENCES "auth"."users"("id") ON DELETE CASCADE;



ALTER TABLE ONLY "public"."ai_generated_images"
    ADD CONSTRAINT "ai_generated_images_advertiser_id_fkey" FOREIGN KEY ("advertiser_id") REFERENCES "public"."organizations"("id") ON DELETE SET NULL;



ALTER TABLE ONLY "public"."ai_generated_images"
    ADD CONSTRAINT "ai_generated_images_usage_log_id_fkey" FOREIGN KEY ("usage_log_id") REFERENCES "public"."ai_usage_logs"("id") ON DELETE CASCADE;



ALTER TABLE ONLY "public"."ai_generated_text"
    ADD CONSTRAINT "ai_generated_text_advertiser_id_fkey" FOREIGN KEY ("advertiser_id") REFERENCES "public"."organizations"("id") ON DELETE SET NULL;



ALTER TABLE ONLY "public"."ai_generated_text"
    ADD CONSTRAINT "ai_generated_text_usage_log_id_fkey" FOREIGN KEY ("usage_log_id") REFERENCES "public"."ai_usage_logs"("id") ON DELETE CASCADE;



ALTER TABLE ONLY "public"."ai_image_guidelines"
    ADD CONSTRAINT "ai_image_guidelines_organization_id_fkey" FOREIGN KEY ("organization_id") REFERENCES "public"."organizations"("id") ON DELETE CASCADE;



ALTER TABLE ONLY "public"."ai_image_guidelines"
    ADD CONSTRAINT "ai_image_guidelines_user_id_fkey" FOREIGN KEY ("user_id") REFERENCES "auth"."users"("id") ON DELETE CASCADE;
...
ALTER TABLE ONLY "public"."ai_provider_configs"
    ADD CONSTRAINT "ai_provider_configs_provider_id_fkey" FOREIGN KEY ("provider_id") REFERENCES "public"."ai_service_providers"("id") ON DELETE CASCADE;
...
ALTER TABLE ONLY "public"."ai_usage_analytics"
    ADD CONSTRAINT "ai_usage_analytics_config_id_fkey" FOREIGN KEY ("config_id") REFERENCES "public"."ai_provider_configs"("id") ON DELETE CASCADE;



ALTER TABLE ONLY "public"."ai_usage_logs"
    ADD CONSTRAINT "ai_usage_logs_config_id_fkey" FOREIGN KEY ("config_id") REFERENCES "public"."ai_provider_configs"("id") ON DELETE CASCADE;
...
ALTER TABLE ONLY "public"."team_images"
    ADD CONSTRAINT "team_images_team_id_fkey" FOREIGN KEY ("team_id") REFERENCES "public"."teams"("id") ON DELETE CASCADE;
...
ALTER TABLE ONLY "public"."users"
    ADD CONSTRAINT "users_admin_discount_applied_by_fkey" FOREIGN KEY ("admin_discount_applied_by") REFERENCES "public"."users"("id");
...
ALTER TABLE ONLY "public"."verification_documents"
    ADD CONSTRAINT "verification_documents_reviewed_by_fkey" FOREIGN KEY ("reviewed_by") REFERENCES "public"."users"("id");
...
CREATE POLICY "Admin settings access for authenticated users" ON "public"."admin_settings" TO "authenticated" USING (true) WITH CHECK (true);
...
CREATE POLICY "Public can view event favorites" ON "public"."event_favorites" FOR SELECT USING (true);
...
CREATE POLICY "Service providers are viewable by authenticated users" ON "public"."ai_service_providers" FOR SELECT USING (("auth"."role"() = 'authenticated'::"text"));
...
CREATE POLICY "System can insert generated images" ON "public"."ai_generated_images" FOR INSERT WITH CHECK (true);



CREATE POLICY "System can insert generated text" ON "public"."ai_generated_text" FOR INSERT WITH CHECK (true);
...
CREATE POLICY "System can manage analytics" ON "public"."ai_usage_analytics" WITH CHECK (true);
...
CREATE POLICY "Users can delete own AI configurations" ON "public"."ai_provider_configs" FOR DELETE USING (("auth"."uid"() = "user_id"));



CREATE POLICY "Users can insert own AI configurations" ON "public"."ai_provider_configs" FOR INSERT WITH CHECK (("auth"."uid"() = "user_id"));
...
CREATE POLICY "Users can manage own content directions" ON "public"."ai_content_directions" USING (("auth"."uid"() = "user_id"));



CREATE POLICY "Users can manage own favorites" ON "public"."event_favorites" USING (("auth"."uid"() = "user_id"));



CREATE POLICY "Users can manage own image guidelines" ON "public"."ai_image_guidelines" USING (("auth"."uid"() = "user_id"));
...
CREATE POLICY "Users can manage their own verification documents" ON "public"."verification_documents" USING (("auth"."uid"() = "user_id")) WITH CHECK (("auth"."uid"() = "user_id"));
...
CREATE POLICY "Users can update own AI configurations" ON "public"."ai_provider_configs" FOR UPDATE USING (("auth"."uid"() = "user_id"));
...
CREATE POLICY "Users can view own AI configurations" ON "public"."ai_provider_configs" FOR SELECT USING (("auth"."uid"() = "user_id"));



CREATE POLICY "Users can view own analytics" ON "public"."ai_usage_analytics" FOR SELECT USING (("config_id" IN ( SELECT "ai_provider_configs"."id"
   FROM "public"."ai_provider_configs"
  WHERE ("ai_provider_configs"."user_id" = "auth"."uid"()))));
...
CREATE POLICY "Users can view own generated images" ON "public"."ai_generated_images" FOR SELECT USING (("usage_log_id" IN ( SELECT "aul"."id"
   FROM ("public"."ai_usage_logs" "aul"
     JOIN "public"."ai_provider_configs" "apc" ON (("aul"."config_id" = "apc"."id")))
  WHERE ("apc"."user_id" = "auth"."uid"()))));



CREATE POLICY "Users can view own generated text" ON "public"."ai_generated_text" FOR SELECT USING (("usage_log_id" IN ( SELECT "aul"."id"
   FROM ("public"."ai_usage_logs" "aul"
     JOIN "public"."ai_provider_configs" "apc" ON (("aul"."config_id" = "apc"."id")))
  WHERE ("apc"."user_id" = "auth"."uid"()))));
...
CREATE POLICY "Users can view own usage logs" ON "public"."ai_usage_logs" FOR SELECT USING (("config_id" IN ( SELECT "ai_provider_configs"."id"
   FROM "public"."ai_provider_configs"
  WHERE ("ai_provider_configs"."user_id" = "auth"."uid"()))));
...
ALTER TABLE "public"."ai_content_directions" ENABLE ROW LEVEL SECURITY;


ALTER TABLE "public"."ai_generated_images" ENABLE ROW LEVEL SECURITY;


ALTER TABLE "public"."ai_generated_text" ENABLE ROW LEVEL SECURITY;


ALTER TABLE "public"."ai_image_guidelines" ENABLE ROW LEVEL SECURITY;
...
GRANT ALL ON FUNCTION "public"."check_user_permission"("p_user_id" "uuid", "p_permission" "text") TO "anon";
GRANT ALL ON FUNCTION "public"."check_user_permission"("p_user_id" "uuid", "p_permission" "text") TO "authenticated";
GRANT ALL ON FUNCTION "public"."check_user_permission"("p_user_id" "uuid", "p_permission" "text") TO "service_role";
...
GRANT ALL ON FUNCTION "public"."create_advertisement"("p_title" "text", "p_description" "text", "p_price" numeric, "p_category" "text", "p_location" "text", "p_contact_info" "text", "p_image_urls" "text"[], "p_user_id" "uuid") TO "anon";
GRANT ALL ON FUNCTION "public"."create_advertisement"("p_title" "text", "p_description" "text", "p_price" numeric, "p_category" "text", "p_location" "text", "p_contact_info" "text", "p_image_urls" "text"[], "p_user_id" "uuid") TO "authenticated";
GRANT ALL ON FUNCTION "public"."create_advertisement"("p_title" "text", "p_description" "text", "p_price" numeric, "p_category" "text", "p_location" "text", "p_contact_info" "text", "p_image_urls" "text"[], "p_user_id" "uuid") TO "service_role";



GRANT ALL ON FUNCTION "public"."create_backup_job"("p_backup_type" "text", "p_schedule" "text", "p_retention_days" integer) TO "anon";
GRANT ALL ON FUNCTION "public"."create_backup_job"("p_backup_type" "text", "p_schedule" "text", "p_retention_days" integer) TO "authenticated";
GRANT ALL ON FUNCTION "public"."create_backup_job"("p_backup_type" "text", "p_schedule" "text", "p_retention_days" integer) TO "service_role";



GRANT ALL ON FUNCTION "public"."create_cms_page"("p_title" "text", "p_slug" "text", "p_content" "text", "p_meta_description" "text", "p_published" boolean, "p_author_id" "uuid") TO "anon";
GRANT ALL ON FUNCTION "public"."create_cms_page"("p_title" "text", "p_slug" "text", "p_content" "text", "p_meta_description" "text", "p_published" boolean, "p_author_id" "uuid") TO "authenticated";
GRANT ALL ON FUNCTION "public"."create_cms_page"("p_title" "text", "p_slug" "text", "p_content" "text", "p_meta_description" "text", "p_published" boolean, "p_author_id" "uuid") TO "service_role";



GRANT ALL ON FUNCTION "public"."create_cms_page"("p_title" "text", "p_slug" "text", "p_content" "text", "p_meta_description" "text", "p_status" "text", "p_author_id" "uuid") TO "anon";
GRANT ALL ON FUNCTION "public"."create_cms_page"("p_title" "text", "p_slug" "text", "p_content" "text", "p_meta_description" "text", "p_status" "text", "p_author_id" "uuid") TO "authenticated";
GRANT ALL ON FUNCTION "public"."create_cms_page"("p_title" "text", "p_slug" "text", "p_content" "text", "p_meta_description" "text", "p_status" "text", "p_author_id" "uuid") TO "service_role";



GRANT ALL ON FUNCTION "public"."create_competition_result"("p_event_id" "uuid", "p_participant_id" "uuid", "p_category" "text", "p_score" numeric, "p_judge_id" "uuid", "p_notes" "text") TO "anon";
GRANT ALL ON FUNCTION "public"."create_competition_result"("p_event_id" "uuid", "p_participant_id" "uuid", "p_category" "text", "p_score" numeric, "p_judge_id" "uuid", "p_notes" "text") TO "authenticated";
GRANT ALL ON FUNCTION "public"."create_competition_result"("p_event_id" "uuid", "p_participant_id" "uuid", "p_category" "text", "p_score" numeric, "p_judge_id" "uuid", "p_notes" "text") TO "service_role";



GRANT ALL ON FUNCTION "public"."create_directory_listing"("p_business_name" "text", "p_description" "text", "p_category" "text", "p_address" "text", "p_city" "text", "p_state" "text", "p_zip_code" "text", "p_phone" "text", "p_email" "text", "p_website" "text", "p_owner_id" "uuid") TO "anon";
GRANT ALL ON FUNCTION "public"."create_directory_listing"("p_business_name" "text", "p_description" "text", "p_category" "text", "p_address" "text", "p_city" "text", "p_state" "text", "p_zip_code" "text", "p_phone" "text", "p_email" "text", "p_website" "text", "p_owner_id" "uuid") TO "authenticated";
GRANT ALL ON FUNCTION "public"."create_directory_listing"("p_business_name" "text", "p_description" "text", "p_category" "text", "p_address" "text", "p_city" "text", "p_state" "text", "p_zip_code" "text", "p_phone" "text", "p_email" "text", "p_website" "text", "p_owner_id" "uuid") TO "service_role";



GRANT ALL ON FUNCTION "public"."create_email_template"("p_name" "text", "p_subject" "text", "p_body_html" "text", "p_body_text" "text", "p_template_type" "text") TO "anon";
GRANT ALL ON FUNCTION "public"."create_email_template"("p_name" "text", "p_subject" "text", "p_body_html" "text", "p_body_text" "text", "p_template_type" "text") TO "authenticated";
GRANT ALL ON FUNCTION "public"."create_email_template"("p_name" "text", "p_subject" "text", "p_body_html" "text", "p_body_text" "text", "p_template_type" "text") TO "service_role";



GRANT ALL ON FUNCTION "public"."create_event"("p_title" "text", "p_description" "text", "p_event_date" timestamp with time zone, "p_location" "text", "p_address" "text", "p_city" "text", "p_state" "text", "p_zip_code" "text", "p_entry_fee" numeric, "p_max_participants" integer, "p_contact_info" "text", "p_organizer_id" "uuid") TO "anon";
GRANT ALL ON FUNCTION "public"."create_event"("p_title" "text", "p_description" "text", "p_event_date" timestamp with time zone, "p_location" "text", "p_address" "text", "p_city" "text", "p_state" "text", "p_zip_code" "text", "p_entry_fee" numeric, "p_max_participants" integer, "p_contact_info" "text", "p_organizer_id" "uuid") TO "authenticated";
GRANT ALL ON FUNCTION "public"."create_event"("p_title" "text", "p_description" "text", "p_event_date" timestamp with time zone, "p_location" "text", "p_address" "text", "p_city" "text", "p_state" "text", "p_zip_code" "text", "p_entry_fee" numeric, "p_max_participants" integer, "p_contact_info" "text", "p_organizer_id" "uuid") TO "service_role";



GRANT ALL ON FUNCTION "public"."create_organization"("p_name" "text", "p_description" "text", "p_type" "text", "p_website" "text", "p_contact_email" "text", "p_contact_phone" "text", "p_address" "text", "p_city" "text", "p_state" "text", "p_zip_code" "text", "p_owner_id" "uuid") TO "anon";
GRANT ALL ON FUNCTION "public"."create_organization"("p_name" "text", "p_description" "text", "p_type" "text", "p_website" "text", "p_contact_email" "text", "p_contact_phone" "text", "p_address" "text", "p_city" "text", "p_state" "text", "p_zip_code" "text", "p_owner_id" "uuid") TO "authenticated";
GRANT ALL ON FUNCTION "public"."create_organization"("p_name" "text", "p_description" "text", "p_type" "text", "p_website" "text", "p_contact_email" "text", "p_contact_phone" "text", "p_address" "text", "p_city" "text", "p_state" "text", "p_zip_code" "text", "p_owner_id" "uuid") TO "service_role";



GRANT ALL ON FUNCTION "public"."create_scraping_job"("p_url" "text", "p_selector" "text", "p_description" "text", "p_schedule" "text") TO "anon";
GRANT ALL ON FUNCTION "public"."create_scraping_job"("p_url" "text", "p_selector" "text", "p_description" "text", "p_schedule" "text") TO "authenticated";
GRANT ALL ON FUNCTION "public"."create_scraping_job"("p_url" "text", "p_selector" "text", "p_description" "text", "p_schedule" "text") TO "service_role";
...
GRANT ALL ON FUNCTION "public"."log_system_event"("p_event_type" "text", "p_description" "text", "p_user_id" "uuid", "p_metadata" "jsonb") TO "anon";
GRANT ALL ON FUNCTION "public"."log_system_event"("p_event_type" "text", "p_description" "text", "p_user_id" "uuid", "p_metadata" "jsonb") TO "authenticated";
GRANT ALL ON FUNCTION "public"."log_system_event"("p_event_type" "text", "p_description" "text", "p_user_id" "uuid", "p_metadata" "jsonb") TO "service_role";
...
GRANT ALL ON FUNCTION "public"."manage_user_session"("p_action" "text", "p_session_data" "jsonb") TO "anon";
GRANT ALL ON FUNCTION "public"."manage_user_session"("p_action" "text", "p_session_data" "jsonb") TO "authenticated";
GRANT ALL ON FUNCTION "public"."manage_user_session"("p_action" "text", "p_session_data" "jsonb") TO "service_role";
...
GRANT ALL ON FUNCTION "public"."perform_global_search"("p_query" "text", "p_search_type" "text", "p_limit" integer) TO "anon";
GRANT ALL ON FUNCTION "public"."perform_global_search"("p_query" "text", "p_search_type" "text", "p_limit" integer) TO "authenticated";
GRANT ALL ON FUNCTION "public"."perform_global_search"("p_query" "text", "p_search_type" "text", "p_limit" integer) TO "service_role";



GRANT ALL ON FUNCTION "public"."process_event_payment"("p_registration_id" "uuid", "p_payment_amount" numeric, "p_payment_method" "text", "p_stripe_payment_intent_id" "text") TO "anon";
GRANT ALL ON FUNCTION "public"."process_event_payment"("p_registration_id" "uuid", "p_payment_amount" numeric, "p_payment_method" "text", "p_stripe_payment_intent_id" "text") TO "authenticated";
GRANT ALL ON FUNCTION "public"."process_event_payment"("p_registration_id" "uuid", "p_payment_amount" numeric, "p_payment_method" "text", "p_stripe_payment_intent_id" "text") TO "service_role";
...
GRANT ALL ON FUNCTION "public"."register_for_event"("p_event_id" "uuid", "p_user_id" "uuid", "p_vehicle_info" "jsonb", "p_category" "text") TO "anon";
GRANT ALL ON FUNCTION "public"."register_for_event"("p_event_id" "uuid", "p_user_id" "uuid", "p_vehicle_info" "jsonb", "p_category" "text") TO "authenticated";
GRANT ALL ON FUNCTION "public"."register_for_event"("p_event_id" "uuid", "p_user_id" "uuid", "p_vehicle_info" "jsonb", "p_category" "text") TO "service_role";



GRANT ALL ON FUNCTION "public"."send_notification"("p_user_id" "uuid", "p_type" "text", "p_title" "text", "p_message" "text", "p_data" "jsonb") TO "anon";
GRANT ALL ON FUNCTION "public"."send_notification"("p_user_id" "uuid", "p_type" "text", "p_title" "text", "p_message" "text", "p_data" "jsonb") TO "authenticated";
GRANT ALL ON FUNCTION "public"."send_notification"("p_user_id" "uuid", "p_type" "text", "p_title" "text", "p_message" "text", "p_data" "jsonb") TO "service_role";
...
GRANT ALL ON FUNCTION "public"."track_page_view"("p_page_path" "text", "p_user_agent" "text", "p_referrer" "text") TO "anon";
GRANT ALL ON FUNCTION "public"."track_page_view"("p_page_path" "text", "p_user_agent" "text", "p_referrer" "text") TO "authenticated";
GRANT ALL ON FUNCTION "public"."track_page_view"("p_page_path" "text", "p_user_agent" "text", "p_referrer" "text") TO "service_role";
...
GRANT ALL ON FUNCTION "public"."update_advertisement"("p_ad_id" "uuid", "p_title" "text", "p_description" "text", "p_price" numeric, "p_category" "text", "p_location" "text", "p_contact_info" "text", "p_image_urls" "text"[]) TO "anon";
GRANT ALL ON FUNCTION "public"."update_advertisement"("p_ad_id" "uuid", "p_title" "text", "p_description" "text", "p_price" numeric, "p_category" "text", "p_location" "text", "p_contact_info" "text", "p_image_urls" "text"[]) TO "authenticated";
GRANT ALL ON FUNCTION "public"."update_advertisement"("p_ad_id" "uuid", "p_title" "text", "p_description" "text", "p_price" numeric, "p_category" "text", "p_location" "text", "p_contact_info" "text", "p_image_urls" "text"[]) TO "service_role";
...
GRANT ALL ON FUNCTION "public"."update_ai_config"("p_config_key" "text", "p_config_value" "text", "p_description" "text") TO "anon";
GRANT ALL ON FUNCTION "public"."update_ai_config"("p_config_key" "text", "p_config_value" "text", "p_description" "text") TO "authenticated";
GRANT ALL ON FUNCTION "public"."update_ai_config"("p_config_key" "text", "p_config_value" "text", "p_description" "text") TO "service_role";



GRANT ALL ON FUNCTION "public"."update_ai_usage_analytics"() TO "anon";
GRANT ALL ON FUNCTION "public"."update_ai_usage_analytics"() TO "authenticated";
GRANT ALL ON FUNCTION "public"."update_ai_usage_analytics"() TO "service_role";



GRANT ALL ON FUNCTION "public"."update_cms_page"("p_page_id" "uuid", "p_title" "text", "p_slug" "text", "p_content" "text", "p_meta_description" "text", "p_published" boolean) TO "anon";
GRANT ALL ON FUNCTION "public"."update_cms_page"("p_page_id" "uuid", "p_title" "text", "p_slug" "text", "p_content" "text", "p_meta_description" "text", "p_published" boolean) TO "authenticated";
GRANT ALL ON FUNCTION "public"."update_cms_page"("p_page_id" "uuid", "p_title" "text", "p_slug" "text", "p_content" "text", "p_meta_description" "text", "p_published" boolean) TO "service_role";



GRANT ALL ON FUNCTION "public"."update_competition_result"("p_result_id" "uuid", "p_score" numeric, "p_notes" "text", "p_judge_id" "uuid") TO "anon";
GRANT ALL ON FUNCTION "public"."update_competition_result"("p_result_id" "uuid", "p_score" numeric, "p_notes" "text", "p_judge_id" "uuid") TO "authenticated";
GRANT ALL ON FUNCTION "public"."update_competition_result"("p_result_id" "uuid", "p_score" numeric, "p_notes" "text", "p_judge_id" "uuid") TO "service_role";



GRANT ALL ON FUNCTION "public"."update_directory_listing"("p_listing_id" "uuid", "p_business_name" "text", "p_description" "text", "p_category" "text", "p_address" "text", "p_city" "text", "p_state" "text", "p_zip_code" "text", "p_phone" "text", "p_email" "text", "p_website" "text") TO "anon";
GRANT ALL ON FUNCTION "public"."update_directory_listing"("p_listing_id" "uuid", "p_business_name" "text", "p_description" "text", "p_category" "text", "p_address" "text", "p_city" "text", "p_state" "text", "p_zip_code" "text", "p_phone" "text", "p_email" "text", "p_website" "text") TO "authenticated";
GRANT ALL ON FUNCTION "public"."update_directory_listing"("p_listing_id" "uuid", "p_business_name" "text", "p_description" "text", "p_category" "text", "p_address" "text", "p_city" "text", "p_state" "text", "p_zip_code" "text", "p_phone" "text", "p_email" "text", "p_website" "text") TO "service_role";



GRANT ALL ON FUNCTION "public"."update_event"("p_event_id" "uuid", "p_title" "text", "p_description" "text", "p_event_date" timestamp with time zone, "p_location" "text", "p_address" "text", "p_city" "text", "p_state" "text", "p_zip_code" "text", "p_entry_fee" numeric, "p_max_participants" integer, "p_contact_info" "text") TO "anon";
GRANT ALL ON FUNCTION "public"."update_event"("p_event_id" "uuid", "p_title" "text", "p_description" "text", "p_event_date" timestamp with time zone, "p_location" "text", "p_address" "text", "p_city" "text", "p_state" "text", "p_zip_code" "text", "p_entry_fee" numeric, "p_max_participants" integer, "p_contact_info" "text") TO "authenticated";
GRANT ALL ON FUNCTION "public"."update_event"("p_event_id" "uuid", "p_title" "text", "p_description" "text", "p_event_date" timestamp with time zone, "p_location" "text", "p_address" "text", "p_city" "text", "p_state" "text", "p_zip_code" "text", "p_entry_fee" numeric, "p_max_participants" integer, "p_contact_info" "text") TO "service_role";
...
GRANT ALL ON FUNCTION "public"."update_organization"("p_org_id" "uuid", "p_name" "text", "p_description" "text", "p_type" "text", "p_website" "text", "p_contact_email" "text", "p_contact_phone" "text", "p_address" "text", "p_city" "text", "p_state" "text", "p_zip_code" "text") TO "anon";
GRANT ALL ON FUNCTION "public"."update_organization"("p_org_id" "uuid", "p_name" "text", "p_description" "text", "p_type" "text", "p_website" "text", "p_contact_email" "text", "p_contact_phone" "text", "p_address" "text", "p_city" "text", "p_state" "text", "p_zip_code" "text") TO "authenticated";
GRANT ALL ON FUNCTION "public"."update_organization"("p_org_id" "uuid", "p_name" "text", "p_description" "text", "p_type" "text", "p_website" "text", "p_contact_email" "text", "p_contact_phone" "text", "p_address" "text", "p_city" "text", "p_state" "text", "p_zip_code" "text") TO "service_role";



GRANT ALL ON FUNCTION "public"."update_subscription"("p_user_id" "uuid", "p_membership_tier" "text", "p_subscription_status" "text", "p_subscription_end_date" timestamp with time zone) TO "anon";
GRANT ALL ON FUNCTION "public"."update_subscription"("p_user_id" "uuid", "p_membership_tier" "text", "p_subscription_status" "text", "p_subscription_end_date" timestamp with time zone) TO "authenticated";
GRANT ALL ON FUNCTION "public"."update_subscription"("p_user_id" "uuid", "p_membership_tier" "text", "p_subscription_status" "text", "p_subscription_end_date" timestamp with time zone) TO "service_role";



GRANT ALL ON FUNCTION "public"."update_system_config"("p_config_key" "text", "p_config_value" "text", "p_description" "text") TO "anon";
GRANT ALL ON FUNCTION "public"."update_system_config"("p_config_key" "text", "p_config_value" "text", "p_description" "text") TO "authenticated";
GRANT ALL ON FUNCTION "public"."update_system_config"("p_config_key" "text", "p_config_value" "text", "p_description" "text") TO "service_role";
...
GRANT ALL ON FUNCTION "public"."update_user_last_login"("user_id" "uuid") TO "anon";
GRANT ALL ON FUNCTION "public"."update_user_last_login"("user_id" "uuid") TO "authenticated";
GRANT ALL ON FUNCTION "public"."update_user_last_login"("user_id" "uuid") TO "service_role";



GRANT ALL ON FUNCTION "public"."update_user_profile"("user_id_param" "uuid", "first_name_param" "text", "last_name_param" "text", "phone_param" "text", "city_param" "text", "state_param" "text", "membership_level_param" "text") TO "anon";
GRANT ALL ON FUNCTION "public"."update_user_profile"("user_id_param" "uuid", "first_name_param" "text", "last_name_param" "text", "phone_param" "text", "city_param" "text", "state_param" "text", "membership_level_param" "text") TO "authenticated";
GRANT ALL ON FUNCTION "public"."update_user_profile"("user_id_param" "uuid", "first_name_param" "text", "last_name_param" "text", "phone_param" "text", "city_param" "text", "state_param" "text", "membership_level_param" "text") TO "service_role";
...
GRANT ALL ON FUNCTION "public"."validate_email_format"("p_email" "text") TO "anon";
GRANT ALL ON FUNCTION "public"."validate_email_format"("p_email" "text") TO "authenticated";
GRANT ALL ON FUNCTION "public"."validate_email_format"("p_email" "text") TO "service_role";
...
GRANT ALL ON TABLE "public"."ai_content_directions" TO "anon";
GRANT ALL ON TABLE "public"."ai_content_directions" TO "authenticated";
GRANT ALL ON TABLE "public"."ai_content_directions" TO "service_role";
...
GRANT ALL ON TABLE "public"."ai_generated_text" TO "anon";
GRANT ALL ON TABLE "public"."ai_generated_text" TO "authenticated";
GRANT ALL ON TABLE "public"."ai_generated_text" TO "service_role";



GRANT ALL ON TABLE "public"."ai_image_guidelines" TO "anon";
GRANT ALL ON TABLE "public"."ai_image_guidelines" TO "authenticated";
GRANT ALL ON TABLE "public"."ai_image_guidelines" TO "service_role";
...
GRANT ALL ON TABLE "public"."ai_service_providers" TO "anon";
GRANT ALL ON TABLE "public"."ai_service_providers" TO "authenticated";
GRANT ALL ON TABLE "public"."ai_service_providers" TO "service_role";



GRANT ALL ON TABLE "public"."ai_usage_analytics" TO "anon";
GRANT ALL ON TABLE "public"."ai_usage_analytics" TO "authenticated";
GRANT ALL ON TABLE "public"."ai_usage_analytics" TO "service_role";



GRANT ALL ON TABLE "public"."ai_provider_usage_summary" TO "anon";
GRANT ALL ON TABLE "public"."ai_provider_usage_summary" TO "authenticated";
GRANT ALL ON TABLE "public"."ai_provider_usage_summary" TO "service_role";
...
GRANT ALL ON TABLE "public"."ai_user_usage_summary" TO "anon";
GRANT ALL ON TABLE "public"."ai_user_usage_summary" TO "authenticated";
GRANT ALL ON TABLE "public"."ai_user_usage_summary" TO "service_role";
...
GRANT ALL ON TABLE "public"."team_images" TO "anon";
GRANT ALL ON TABLE "public"."team_images" TO "authenticated";
GRANT ALL ON TABLE "public"."team_images" TO "service_role";
