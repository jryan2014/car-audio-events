-- Fix rules_templates table for OrganizationManager (Version 2)
-- This handles existing table conflicts and missing columns
...
-- Ensure the rules_content column is NOT NULL (if it was added as nullable)
