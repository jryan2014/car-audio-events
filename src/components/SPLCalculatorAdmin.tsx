...
export default function SPLCalculatorAdmin({ className = '' }: SPLCalculatorAdminProps) {
  ...
  useEffect(() => {
    // Only filter users if we have a search term with at least 2 characters
  ...
  return (
    <div className={`bg-gray-900 min-h-screen ${className}`}>
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
              ...
              <div className="space-y-4">
                ...
                <div className="grid md:grid-cols-2 gap-4">
                  ...
                  >
                    <div className="flex items-center gap-2 mb-2">
                      ...
                      <span className="font-medium">Disabled (Maintenance Mode)</span>
                    </div>
                ...
                <div className="grid md:grid-cols-2 gap-4">
                  <button
                    ...
                    disabled={saving}
                    className={`p-4 rounded-lg border-2 text-left transition-colors ${
                      featureFlag.access_mode === 'all_paid' && featureFlag.is_enabled
                        ? 'border-green-500 bg-green-500/10 text-green-300'
                        : 'border-gray-600 bg-gray-700 text-gray-300 hover:border-green-500'
                    }`}
                  >
        ...
        {/* User Management - Show when feature is enabled */}
