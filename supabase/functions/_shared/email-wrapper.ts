...
export const EMAIL_TEMPLATE_STYLES = `
  <style>
    ...
    /* Main Styles - Matching website gradient background */
    body {
      margin: 0 !important;
      padding: 0 !important;
    ...
    /* Outer wrapper to create website background effect */
    .email-wrapper {
    ...
    .email-header {
      background: linear-gradient(to right, rgba(0, 0, 0, 0.9) 0%, rgba(88, 28, 135, 0.9) 100%);
