...
(0, server_ts_1.serve)(function (req) { return __awaiter(void 0, void 0, void 0, function () {
    var supabaseClient, createError, error_1;
    var _a, _b;
    return __generator(this, function (_c) {
        switch (_c.label) {
            ...
            case 1:
                _c.trys.push([1, 3, , 4]);
                supabaseClient = (0, supabase_js_2_1.createClient)((_a = Deno.env.get('SUPABASE_URL')) !== null && _a !== void 0 ? _a : '', (_b = Deno.env.get('SUPABASE_SERVICE_ROLE_KEY')) !== null && _b !== void 0 ? _b : '');
            ...
            case 2:
                ...
                if (createError) {
                    ...
                    return [2 /*return*/, new Response(JSON.stringify({ error: "Failed to create table: ".concat(createError.message) }), { status: 500, headers: __assign(__assign({}, corsHeaders), { 'Content-Type': 'application/json' }) })];
                }
            ...
            case 3:
                error_1 = _c.sent();
                console.error('Create table function error:', error_1);
