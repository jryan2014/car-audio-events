...
(0, server_ts_1.serve)(function (req) { return __awaiter(void 0, void 0, void 0, function () {
    var supabaseClient, url, type, query, _a, plans, error, transformedPlans, error_1;
    var _b, _c;
    return __generator(this, function (_d) {
        switch (_d.label) {
            ...
            case 2:
                _a = _d.sent(), plans = _a.data, error = _a.error;
                if (error) {
                    console.error('Database error:', error);
                    return [2 /*return*/, new Response(JSON.stringify({ error: 'Failed to fetch membership plans', details: error.message }), {
                            status: 500,
                            headers: __assign(__assign({}, corsHeaders), { 'Content-Type': 'application/json' })
                        })];
                }
                transformedPlans = (plans === null || plans === void 0 ? void 0 : plans.map(function (plan) { return ({
                    id: plan.id,
                    name: plan.name,
            ...
            case 3:
                ...
                return [2 /*return*/, new Response(JSON.stringify({ error: 'Internal server error', details: error_1.message }), {
                        status: 500,
                        headers: __assign(__assign({}, corsHeaders), { 'Content-Type': 'application/json' })
                    })];
