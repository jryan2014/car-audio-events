...
Deno.serve(function (req) { return __awaiter(void 0, void 0, void 0, function () {
    var supabaseClient, authHeader, token, _a, user, authError, eventData, requiredFields, _i, requiredFields_1, field, _b, userData, userError, isAdmin, _c, currentEvent, eventError, addressChanged, needsGeocoding, geocodeResult, locationData, locationError, fallbackCoords, locationData, geocodeResult, fallbackCoords, _d, updatedEvent, updateError, _e, forceUpdateResult, forceUpdateError, forceUpdateError_1, error_2;
    var _f, _g;
        ...
        switch (_h.label) {
            ...
            case 4:
                ...
                return [4 /*yield*/, supabaseClient
                        ...
                        .single()];
            case 5:
                _c = _h.sent(), currentEvent = _c.data, eventError = _c.error;
                if (eventError) {
                ...
                if (!isAdmin && currentEvent.organizer_id !== user.id) {
                    return [2 /*return*/, new Response(JSON.stringify({ error: 'You do not have permission to update this event' }), {
                            status: 403,
                            headers: __assign(__assign({}, corsHeaders), { 'Content-Type': 'application/json' })
                        })];
                }
                addressChanged = eventData.address !== currentEvent.address ||
                    eventData.city !== currentEvent.city ||
                    eventData.state !== currentEvent.state ||
                    eventData.country !== currentEvent.country;
                needsGeocoding = addressChanged ||
                    !currentEvent.latitude ||
                    !currentEvent.longitude ||
                    currentEvent.latitude === 0 ||
                    currentEvent.longitude === 0;
                if (!needsGeocoding) return [3 /*break*/, 11];
            ...
            case 6:
                ...
                if (!geocodeResult) return [3 /*break*/, 8];
            ...
            case 8:
                ...
                if (!fallbackCoords) return [3 /*break*/, 10];
                ...
                locationData = {
                    ...
                    formatted_address: "".concat(eventData.city, ", ").concat(eventData.state, ", ").concat(eventData.country || 'US'),
                    geocoded_at: new Date().toISOString()
                };
                return [4 /*yield*/, supabaseClient
                        .from('event_locations')
            ...
            case 11:
                if (!(!currentEvent.latitude || !currentEvent.longitude ||
                    currentEvent.latitude === 0 || currentEvent.longitude === 0)) return [3 /*break*/, 13];
            ...
            case 14:
                ...
                return [4 /*yield*/, supabaseClient
                        ...
                        .single()];
            case 15:
                _d = _h.sent(), updatedEvent = _d.data, updateError = _d.error;
                if (updateError) {
                    return [2 /*return*/, new Response(JSON.stringify({ error: 'Failed to update event', details: updateError.message }), {
                            status: 500,
                            headers: __assign(__assign({}, corsHeaders), { 'Content-Type': 'application/json' })
                        })];
                }
